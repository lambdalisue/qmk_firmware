...
[_BL] = LAYOUT_ergodox(
      ...
      MO_HHKB, KC_CAPS, KC_LALT, KC_LGUI, K_MEISU,
                                                   KC_RGUI, KC_RALT,
                                                            KC_PSCR,
      ...
      KC_NUHS, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RO,
                        K_MKANA, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,
      KC_INS,  KC_SLCK,
      KC_BRK,
